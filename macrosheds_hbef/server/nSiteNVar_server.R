...
observeEvent(input$REFRESH, {
    print('REFRESH')
    # reactive_vals$precip3 = reactive_vals$precip3 + 1
    ...
    # reactive_vals$discharge3 = reactive_vals$discharge3 + 1
})
...
output$GRAPH_Q3 <- renderDygraph({
    ...
    # if(reactive_vals$discharge3 == 0) return()
